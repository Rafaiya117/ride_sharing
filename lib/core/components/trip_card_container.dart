...
class HistoryTripCard extends StatelessWidget {
      ...
      children: [
        Row(
          children: [
            ...
            SizedBox(width: 8.w),
            Text(trip.date, style: GoogleFonts.inter(color: Colors.grey.shade700, fontSize: 13.sp)),
          ],
        ),
        Container(
          ...
          child: Text(
            "Completed",
            style: GoogleFonts.inter(color: const Color(0xFF27AE60), fontWeight: FontWeight.bold, fontSize: 12.sp),
          ),
        )
      ],
    );
    ...
    return Row(
      children: [
        Container(
          ...
          child: Center(child: Text(trip.driverInitial, style: GoogleFonts.inter(color: Colors.white, fontWeight: FontWeight.bold))),
        ),
        SizedBox(width: 12.w),
        Expanded(
          child: Column(
            ...
            children: [
              Text(trip.driverName, style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 16.sp, color: Colors.black)),
              Row(
                children: [
                  Icon(Icons.star, size: 14.r, color: Colors.amber),
                  Text(" ${trip.formattedRating}", style: GoogleFonts.inter(fontSize: 12.sp, color: Colors.grey.shade700)),
                ],
              ),
            ],
          ),
        ...
        Column(
          ...
          children: [
            Text("\$${trip.price.toInt()}", style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 20.sp, color: Colors.black)),
  ...
  Widget _routeRow(IconData icon, Color color, String location) {
    return Row(
      children: [
        ...
        SizedBox(width: 12.w),
        Text(location, style: GoogleFonts.inter(fontSize: 15.sp, fontWeight: FontWeight.w600, color: Colors.black)),
      ],
    );
  }
  ...
  Widget _outlinedButton(String text, IconData icon) {
    return OutlinedButton.icon(
      ...
      label: Text(text, style: GoogleFonts.inter(color: Colors.black, fontWeight: FontWeight.bold)),
