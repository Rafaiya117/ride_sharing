...
class DriverReviewView extends StatelessWidget {
  const DriverReviewView({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Provider.of<DriveReviewsController>(context);
    ...
    return BaseScaffold(
      ...
      child: Column(
        children: [
          ...
          ListView.builder(
            padding: EdgeInsets.zero, // FIX: Removes the default top/bottom list padding
            shrinkWrap: true,
