      ...
      child: Column(
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.inter(color: Colors.grey.shade500, fontSize: 12.sp),
          ),
        ],
      ),
    );
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(trip.driverName, style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 15.sp)),
                    SizedBox(height: 2.h),
                    Text(trip.durationOrCar, style: GoogleFonts.inter(color: Colors.grey.shade600, fontSize: 12.sp)),
                  ],
                ),
              ),
              ElevatedButton(
                ...
                child: Text("Track", style: GoogleFonts.inter(fontWeight: FontWeight.w600, fontSize: 14.sp)),
              )
            ],
          ),
        ],
      ...
      child: IntrinsicHeight(
        child: Row(
          children: [
            Column(
              children: [
                Container(width: 8.r, height: 8.r, decoration: BoxDecoration(color: Colors.grey.shade400, shape: BoxShape.circle)),
                Expanded(child: VerticalDivider(color: Colors.grey.shade300, thickness: 1, indent: 4, endIndent: 4)),
                Container(width: 8.r, height: 8.r, decoration: const BoxDecoration(color: Colors.black, shape: BoxShape.circle)),
              ],
            ),
            SizedBox(width: 14.w),
            Expanded(
              child: Column(
                ...
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text(pickup, style: GoogleFonts.inter(fontSize: 15.sp, fontWeight: FontWeight.bold, color: const Color(0xFF111111))),
                  SizedBox(height: 14.h),
                  Text(dropoff, style: GoogleFonts.inter(fontSize: 15.sp, fontWeight: FontWeight.bold, color: const Color(0xFF111111))),
                ],
              ),
            ),
          ],
